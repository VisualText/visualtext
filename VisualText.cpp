...
CString appStrCopyright = _T("VisualText® Copyright © 1999 - 2014 Text Analysis International, Inc.  All rights reserved. NLP++® Copyright © 2000 - 2014 Text Analysis International, Inc.  All rights reserved.Conceptual Grammar™ Copyright © 1999 - 2014 Text Analysis International, Inc.  All rights reserved. Patents Pending");
...
CDocument* CVisualTextApp::OpenDocumentFile(LPCTSTR lpszFileName, bool showFlag) 
{
	...
	CDocument *doc = (CDocument *)CVisualTextApp::OpenNewDocument(templateName,path,showFlag);
	return doc;
}
...
CDocument* CVisualTextApp::OpenDocumentFile(LPCTSTR lpszFileName) 
{
	...
	CDocument *doc = (CDocument *)CVisualTextApp::OpenNewDocument(templateName,path);
	return doc;
}
